...
var map__13488 = hex_data;
var map__13488__$1 = cljs.core.__destructure_map(map__13488);
var coord = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13488__$1,new cljs.core.Keyword(null,"coord","coord",-1453656639));
var resource = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13488__$1,new cljs.core.Keyword(null,"resource","resource",251898836));
var number = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13488__$1,new cljs.core.Keyword(null,"number","number",1570378438));
...
var vec__13489 = catan_board.utils.hex.hex_center(coord,hex_size);
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13489,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13489,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13495),catan_board$views$hex$hex_tile_$_iter__13492(cljs.core.chunk_rest(s__13493__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13495),null);
}
} else {
var i = cljs.core.first(s__13493__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"cx","cx",1272694324),(cx + ((i - ((pips - (1)) / (2))) * (3))),new cljs.core.Keyword(null,"cy","cy",755331060),(cy + (10)),new cljs.core.Keyword(null,"r","r",-471384190),1.5,new cljs.core.Keyword(null,"fill","fill",883462889),((is_red_QMARK_)?"#ffffff":"#333")], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null)),catan_board$views$hex$hex_tile_$_iter__13492(cljs.core.rest(s__13493__$2)));
}
} else {
return null;
}
...
})():null),(cljs.core.truth_(developer_mode_QMARK_)?(function (){var vec__13496 = coord;
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13496,(0),null);
...
var vec__13499 = center;
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13499,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13499,(1),null);
...
var hex_size = catan_board.db.hex_size;
var vec__13502 = catan_board.utils.hex.hex_center(coord,hex_size);
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13502,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13502,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),(function (){var iter__5480__auto__ = (function catan_board$views$hex$harbor_direction_selector_$_iter__13505(s__13506){
return (new cljs.core.LazySeq(null,(function (){
...
var direction = cljs.core._nth(c__5478__auto__,i__13507);
cljs.core.chunk_append(b__13508,(function (){var vec__13509 = catan_board.views.hex.get_edge_points(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null),hex_size,direction);
var vec__13512 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13509,(0),null);
var x1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13512,(0),null);
var y1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13512,(1),null);
var vec__13515 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13509,(1),null);
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13515,(0),null);
var y2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13515,(1),null);
var mid_x = ((x1 + x2) / (2));
var mid_y = ((y1 + y2) / (2));
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"polygon","polygon",837053759),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"points","points",-1486596883),points,new cljs.core.Keyword(null,"fill","fill",883462889),"rgba(52, 152, 219, 0.7)",new cljs.core.Keyword(null,"stroke","stroke",1741823555),"#2980b9",new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),(2),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__13507,vec__13509,vec__13512,x1,y1,vec__13515,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__13508,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy){
return (function (e){
e.stopPropagation();
...
});})(i__13507,vec__13509,vec__13512,x1,y1,vec__13515,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__13508,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy))
,new cljs.core.Keyword(null,"on-mouse-over","on-mouse-over",-858472552),((function (i__13507,vec__13509,vec__13512,x1,y1,vec__13515,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__13508,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy){
return (function (e){
return e.target.style.setProperty("fill","rgba(52, 152, 219, 0.9)");
});})(i__13507,vec__13509,vec__13512,x1,y1,vec__13515,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__13508,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy))
,new cljs.core.Keyword(null,"on-mouse-out","on-mouse-out",643448647),((function (i__13507,vec__13509,vec__13512,x1,y1,vec__13515,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__13508,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy){
return (function (e){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13508),catan_board$views$hex$harbor_direction_selector_$_iter__13505(cljs.core.chunk_rest(s__13506__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13508),null);
}
} else {
var direction = cljs.core.first(s__13506__$2);
return cljs.core.cons((function (){var vec__13518 = catan_board.views.hex.get_edge_points(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null),hex_size,direction);
var vec__13521 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13518,(0),null);
var x1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13521,(0),null);
var y1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13521,(1),null);
var vec__13524 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13518,(1),null);
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13524,(0),null);
var y2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13524,(1),null);
var mid_x = ((x1 + x2) / (2));
var mid_y = ((y1 + y2) / (2));
var outer_dist = (hex_size * 0.3);
var angle = Math.atan2((mid_y - cy),(mid_x - cx));
...
var outer_y = (mid_y + (outer_dist * Math.sin(angle)));
var points = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(x1),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x2),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y2)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(outer_x),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(outer_y)].join('');
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"polygon","polygon",837053759),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"points","points",-1486596883),points,new cljs.core.Keyword(null,"fill","fill",883462889),"rgba(52, 152, 219, 0.7)",new cljs.core.Keyword(null,"stroke","stroke",1741823555),"#2980b9",new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),(2),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__13518,vec__13521,x1,y1,vec__13524,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy){
return (function (e){
e.stopPropagation();

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-harbor-direction","set-harbor-direction",1655338539),coord,direction], null));
});})(vec__13518,vec__13521,x1,y1,vec__13524,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy))
,new cljs.core.Keyword(null,"on-mouse-over","on-mouse-over",-858472552),((function (vec__13518,vec__13521,x1,y1,vec__13524,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy){
return (function (e){
return e.target.style.setProperty("fill","rgba(52, 152, 219, 0.9)");
});})(vec__13518,vec__13521,x1,y1,vec__13524,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy))
,new cljs.core.Keyword(null,"on-mouse-out","on-mouse-out",643448647),((function (vec__13518,vec__13521,x1,y1,vec__13524,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy){
return (function (e){
return e.target.style.setProperty("fill","rgba(52, 152, 219, 0.7)");
});})(vec__13518,vec__13521,x1,y1,vec__13524,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__13506__$2,temp__5804__auto__,hex_size,vec__13502,cx,cy))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),direction], null));
})(),catan_board$views$hex$harbor_direction_selector_$_iter__13505(cljs.core.rest(s__13506__$2)));
}
} else {
return null;
}
...
var map__13527 = harbor_data;
var map__13527__$1 = cljs.core.__destructure_map(map__13527);
var land_hex = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13527__$1,new cljs.core.Keyword(null,"land-hex","land-hex",151922960));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13527__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13527__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var hex_size = catan_board.db.hex_size;
var vec__13528 = catan_board.utils.hex.axial_to_pixel(land_hex,hex_size);
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13528,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13528,(1),null);
var vec__13531 = catan_board.views.hex.get_edge_points(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null),hex_size,direction);
var vec__13534 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13531,(0),null);
var x1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13534,(0),null);
var y1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13534,(1),null);
var vec__13537 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13531,(1),null);
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13537,(0),null);
var y2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13537,(1),null);
var mid_x = ((x1 + x2) / (2));
var mid_y = ((y1 + y2) / (2));
...
var resource_icon = (function (){var G__13540 = type;
var G__13540__$1 = (((G__13540 instanceof cljs.core.Keyword))?G__13540.fqn:null);
switch (G__13540__$1) {
case "wood":
return "\uD83C\uDF32";
 ...
 * fog-state: map of [q r] -> {:revealed? boolean :terrain keyword :number int}
 */
catan_board.views.hex.hex_grid = (function catan_board$views$hex$hex_grid(p__13542){
var map__13543 = p__13542;
var map__13543__$1 = cljs.core.__destructure_map(map__13543);
var scenario = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13543__$1,new cljs.core.Keyword(null,"scenario","scenario",-316635333));
var hexes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13543__$1,new cljs.core.Keyword(null,"hexes","hexes",-1419989846));
var harbors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13543__$1,new cljs.core.Keyword(null,"harbors","harbors",1522363032));
var swap_number_mode_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13543__$1,new cljs.core.Keyword(null,"swap-number-mode?","swap-number-mode?",-906147176));
var selected_token_coord = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13543__$1,new cljs.core.Keyword(null,"selected-token-coord","selected-token-coord",1371480460));
var developer_mode_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13543__$1,new cljs.core.Keyword(null,"developer-mode?","developer-mode?",-664498178));
var fog_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13543__$1,new cljs.core.Keyword(null,"fog-state","fog-state",-562317010));
...
var all_pixels = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13541_SHARP_){
return catan_board.utils.hex.axial_to_pixel(p1__13541_SHARP_,hex_size);
}),all_coords);
var landscape_mode_QMARK_ = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"landscape-mode?","landscape-mode?",1839338284)], null)));
...
var vec__13544 = catan_board.views.hex.compute_original_center(grid_pattern,all_pixels,padding);
var center_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13544,(0),null);
var center_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13544,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13550),catan_board$views$hex$hex_grid_$_iter__13547(cljs.core.chunk_rest(s__13548__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13550),null);
}
} else {
var hex_data = cljs.core.first(s__13548__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.hex.hex_tile,hex_data,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["hex-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword(null,"coord","coord",-1453656639).cljs$core$IFn$_invoke$arity$1(hex_data))),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(new cljs.core.Keyword(null,"coord","coord",-1453656639).cljs$core$IFn$_invoke$arity$1(hex_data)))].join('')], null)),catan_board$views$hex$hex_grid_$_iter__13547(cljs.core.rest(s__13548__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),(function (){var iter__5480__auto__ = (function catan_board$views$hex$hex_grid_$_iter__13551(s__13552){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13554),catan_board$views$hex$hex_grid_$_iter__13551(cljs.core.chunk_rest(s__13552__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13554),null);
}
} else {
var harbor_data = cljs.core.first(s__13552__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.hex.harbor_trapezoid,harbor_data], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["harbor-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword(null,"land-hex","land-hex",151922960).cljs$core$IFn$_invoke$arity$1(harbor_data))),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(new cljs.core.Keyword(null,"land-hex","land-hex",151922960).cljs$core$IFn$_invoke$arity$1(harbor_data))),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"direction","direction",-633359395).cljs$core$IFn$_invoke$arity$1(harbor_data))].join('')], null)),catan_board$views$hex$hex_grid_$_iter__13551(cljs.core.rest(s__13552__$2)));
}
} else {
return null;
}
...
})()], null),(cljs.core.truth_(harbor_placement_coord)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.hex.harbor_direction_selector,harbor_placement_coord], null):null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),(function (){var iter__5480__auto__ = (function catan_board$views$hex$hex_grid_$_iter__13555(s__13556){
return (new cljs.core.LazySeq(null,(function (){
var s__13556__$1 = s__13556;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__13556__$1);
if(temp__5804__auto__){
var s__13556__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13556__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__13556__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__13558 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__13557 = (0);
while(true){
if((i__13557 < size__5479__auto__)){
var map__13559 = cljs.core._nth(c__5478__auto__,i__13557);
var map__13559__$1 = cljs.core.__destructure_map(map__13559);
var coord = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13559__$1,new cljs.core.Keyword(null,"coord","coord",-1453656639));
cljs.core.chunk_append(b__13558,(function (){var hex_size__$1 = catan_board.db.hex_size;
var vertices = catan_board.utils.hex.hex_vertices(coord,hex_size__$1);
var iter__5480__auto__ = ((function (i__13557,hex_size__$1,vertices,map__13559,map__13559__$1,coord,c__5478__auto__,size__5479__auto__,b__13558,s__13556__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__13544,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__13543,map__13543__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state){
return (function catan_board$views$hex$hex_grid_$_iter__13555_$_iter__13560(s__13561){
return (new cljs.core.LazySeq(null,((function (i__13557,hex_size__$1,vertices,map__13559,map__13559__$1,coord,c__5478__auto__,size__5479__auto__,b__13558,s__13556__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__13544,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__13543,map__13543__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state){
return (function (){
...
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13564,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13564,(1),null);
cljs.core.chunk_append(b__13563,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"cx","cx",1272694324),x,new cljs.core.Keyword(null,"cy","cy",755331060),y,new cljs.core.Keyword(null,"r","r",-471384190),(10),new cljs.core.Keyword(null,"fill","fill",883462889),catan_board.utils.hex.path_color], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["dot-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y)].join('')], null)));

var G__13624 = (i__13562 + (1));
i__13562 = G__13624;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13563),catan_board$views$hex$hex_grid_$_iter__13555_$_iter__13560(cljs.core.chunk_rest(s__13561__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13563),null);
}
} else {
var vec__13567 = cljs.core.first(s__13561__$2);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13567,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13567,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"cx","cx",1272694324),x,new cljs.core.Keyword(null,"cy","cy",755331060),y,new cljs.core.Keyword(null,"r","r",-471384190),(10),new cljs.core.Keyword(null,"fill","fill",883462889),catan_board.utils.hex.path_color], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["dot-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y)].join('')], null)),catan_board$views$hex$hex_grid_$_iter__13555_$_iter__13560(cljs.core.rest(s__13561__$2)));
}
} else {
return null;
}
...
});})(i__13557,hex_size__$1,vertices,map__13559,map__13559__$1,coord,c__5478__auto__,size__5479__auto__,b__13558,s__13556__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__13544,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__13543,map__13543__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state))
,null,null));
});})(i__13557,hex_size__$1,vertices,map__13559,map__13559__$1,coord,c__5478__auto__,size__5479__auto__,b__13558,s__13556__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__13544,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__13543,map__13543__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13558),catan_board$views$hex$hex_grid_$_iter__13555(cljs.core.chunk_rest(s__13556__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13558),null);
}
} else {
var map__13570 = cljs.core.first(s__13556__$2);
var map__13570__$1 = cljs.core.__destructure_map(map__13570);
var coord = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13570__$1,new cljs.core.Keyword(null,"coord","coord",-1453656639));
return cljs.core.cons((function (){var hex_size__$1 = catan_board.db.hex_size;
var vertices = catan_board.utils.hex.hex_vertices(coord,hex_size__$1);
var iter__5480__auto__ = ((function (hex_size__$1,vertices,map__13570,map__13570__$1,coord,s__13556__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__13544,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__13543,map__13543__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state){
return (function catan_board$views$hex$hex_grid_$_iter__13555_$_iter__13571(s__13572){
return (new cljs.core.LazySeq(null,(function (){
var s__13572__$1 = s__13572;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__13572__$1);
if(temp__5804__auto____$1){
var s__13572__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__13572__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__13572__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__13574 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__13573 = (0);
while(true){
if((i__13573 < size__5479__auto__)){
var vec__13575 = cljs.core._nth(c__5478__auto__,i__13573);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13575,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13575,(1),null);
cljs.core.chunk_append(b__13574,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"cx","cx",1272694324),x,new cljs.core.Keyword(null,"cy","cy",755331060),y,new cljs.core.Keyword(null,"r","r",-471384190),(10),new cljs.core.Keyword(null,"fill","fill",883462889),catan_board.utils.hex.path_color], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["dot-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y)].join('')], null)));

var G__13626 = (i__13573 + (1));
i__13573 = G__13626;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13574),catan_board$views$hex$hex_grid_$_iter__13555_$_iter__13571(cljs.core.chunk_rest(s__13572__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13574),null);
}
} else {
var vec__13578 = cljs.core.first(s__13572__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"cx","cx",1272694324),x,new cljs.core.Keyword(null,"cy","cy",755331060),y,new cljs.core.Keyword(null,"r","r",-471384190),(10),new cljs.core.Keyword(null,"fill","fill",883462889),catan_board.utils.hex.path_color], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["dot-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y)].join('')], null)),catan_board$views$hex$hex_grid_$_iter__13555_$_iter__13571(cljs.core.rest(s__13572__$2)));
}
} else {
return null;
}
...
});})(hex_size__$1,vertices,map__13570,map__13570__$1,coord,s__13556__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__13544,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__13543,map__13543__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state))
;
return iter__5480__auto__(vertices);
})(),catan_board$views$hex$hex_grid_$_iter__13555(cljs.core.rest(s__13556__$2)));
}
} else {
return null;
}
