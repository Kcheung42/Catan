...
var map__26444 = hex_data;
var map__26444__$1 = cljs.core.__destructure_map(map__26444);
var coord = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26444__$1,new cljs.core.Keyword(null,"coord","coord",-1453656639));
var resource = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26444__$1,new cljs.core.Keyword(null,"resource","resource",251898836));
var number = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26444__$1,new cljs.core.Keyword(null,"number","number",1570378438));
...
var vec__26445 = catan_board.utils.hex.hex_center(coord,hex_size);
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26445,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26445,(1),null);
...
})():null),(cljs.core.truth_(developer_mode_QMARK_)?(function (){var vec__26452 = coord;
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26452,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26452,(1),null);
...
var vec__26455 = center;
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26455,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26455,(1),null);
...
var hex_size = catan_board.db.hex_size;
var vec__26458 = catan_board.utils.hex.hex_center(coord,hex_size);
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26458,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26458,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),(function (){var iter__5480__auto__ = (function catan_board$views$hex$harbor_direction_selector_$_iter__26461(s__26462){
return (new cljs.core.LazySeq(null,(function (){
var s__26462__$1 = s__26462;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26462__$1);
if(temp__5804__auto__){
var s__26462__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26462__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__26462__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__26464 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__26463 = (0);
while(true){
if((i__26463 < size__5479__auto__)){
var direction = cljs.core._nth(c__5478__auto__,i__26463);
cljs.core.chunk_append(b__26464,(function (){var vec__26465 = catan_board.views.hex.get_edge_points(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null),hex_size,direction);
var vec__26468 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26465,(0),null);
var x1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26468,(0),null);
var y1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26468,(1),null);
var vec__26471 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26465,(1),null);
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26471,(0),null);
var y2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26471,(1),null);
var mid_x = ((x1 + x2) / (2));
var mid_y = ((y1 + y2) / (2));
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"polygon","polygon",837053759),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"points","points",-1486596883),points,new cljs.core.Keyword(null,"fill","fill",883462889),"rgba(52, 152, 219, 0.7)",new cljs.core.Keyword(null,"stroke","stroke",1741823555),"#2980b9",new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),(2),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__26463,vec__26465,vec__26468,x1,y1,vec__26471,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__26464,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy){
return (function (e){
e.stopPropagation();
...
});})(i__26463,vec__26465,vec__26468,x1,y1,vec__26471,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__26464,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy))
,new cljs.core.Keyword(null,"on-mouse-over","on-mouse-over",-858472552),((function (i__26463,vec__26465,vec__26468,x1,y1,vec__26471,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__26464,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy){
return (function (e){
return e.target.style.setProperty("fill","rgba(52, 152, 219, 0.9)");
});})(i__26463,vec__26465,vec__26468,x1,y1,vec__26471,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__26464,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy))
,new cljs.core.Keyword(null,"on-mouse-out","on-mouse-out",643448647),((function (i__26463,vec__26465,vec__26468,x1,y1,vec__26471,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,c__5478__auto__,size__5479__auto__,b__26464,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy){
return (function (e){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26464),catan_board$views$hex$harbor_direction_selector_$_iter__26461(cljs.core.chunk_rest(s__26462__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26464),null);
}
} else {
var direction = cljs.core.first(s__26462__$2);
return cljs.core.cons((function (){var vec__26474 = catan_board.views.hex.get_edge_points(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null),hex_size,direction);
var vec__26477 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26474,(0),null);
var x1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26477,(0),null);
var y1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26477,(1),null);
var vec__26480 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26474,(1),null);
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26480,(0),null);
var y2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26480,(1),null);
var mid_x = ((x1 + x2) / (2));
var mid_y = ((y1 + y2) / (2));
var outer_dist = (hex_size * 0.3);
var angle = Math.atan2((mid_y - cy),(mid_x - cx));
...
var outer_y = (mid_y + (outer_dist * Math.sin(angle)));
var points = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(x1),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y1)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x2),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y2)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(outer_x),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(outer_y)].join('');
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"polygon","polygon",837053759),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"points","points",-1486596883),points,new cljs.core.Keyword(null,"fill","fill",883462889),"rgba(52, 152, 219, 0.7)",new cljs.core.Keyword(null,"stroke","stroke",1741823555),"#2980b9",new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),(2),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__26474,vec__26477,x1,y1,vec__26480,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy){
return (function (e){
e.stopPropagation();

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-harbor-direction","set-harbor-direction",1655338539),coord,direction], null));
});})(vec__26474,vec__26477,x1,y1,vec__26480,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy))
,new cljs.core.Keyword(null,"on-mouse-over","on-mouse-over",-858472552),((function (vec__26474,vec__26477,x1,y1,vec__26480,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy){
return (function (e){
return e.target.style.setProperty("fill","rgba(52, 152, 219, 0.9)");
});})(vec__26474,vec__26477,x1,y1,vec__26480,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy))
,new cljs.core.Keyword(null,"on-mouse-out","on-mouse-out",643448647),((function (vec__26474,vec__26477,x1,y1,vec__26480,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy){
return (function (e){
return e.target.style.setProperty("fill","rgba(52, 152, 219, 0.7)");
});})(vec__26474,vec__26477,x1,y1,vec__26480,x2,y2,mid_x,mid_y,outer_dist,angle,outer_x,outer_y,points,direction,s__26462__$2,temp__5804__auto__,hex_size,vec__26458,cx,cy))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),direction], null));
})(),catan_board$views$hex$harbor_direction_selector_$_iter__26461(cljs.core.rest(s__26462__$2)));
}
} else {
return null;
}
...
var map__26483 = harbor_data;
var map__26483__$1 = cljs.core.__destructure_map(map__26483);
var land_hex = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26483__$1,new cljs.core.Keyword(null,"land-hex","land-hex",151922960));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26483__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26483__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var hex_size = catan_board.db.hex_size;
var vec__26484 = catan_board.utils.hex.axial_to_pixel(land_hex,hex_size);
var cx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26484,(0),null);
var cy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26484,(1),null);
var vec__26487 = catan_board.views.hex.get_edge_points(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null),hex_size,direction);
var vec__26490 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26487,(0),null);
var x1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26490,(0),null);
var y1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26490,(1),null);
var vec__26493 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26487,(1),null);
var x2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26493,(0),null);
var y2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26493,(1),null);
var mid_x = ((x1 + x2) / (2));
var mid_y = ((y1 + y2) / (2));
...
var resource_icon = (function (){var G__26496 = type;
 ...
 * fog-state: map of [q r] -> {:revealed? boolean :terrain keyword :number int}
 */
catan_board.views.hex.hex_grid = (function catan_board$views$hex$hex_grid(p__26498){
var map__26499 = p__26498;
var map__26499__$1 = cljs.core.__destructure_map(map__26499);
var scenario = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26499__$1,new cljs.core.Keyword(null,"scenario","scenario",-316635333));
var hexes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26499__$1,new cljs.core.Keyword(null,"hexes","hexes",-1419989846));
var harbors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26499__$1,new cljs.core.Keyword(null,"harbors","harbors",1522363032));
var swap_number_mode_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26499__$1,new cljs.core.Keyword(null,"swap-number-mode?","swap-number-mode?",-906147176));
var selected_token_coord = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26499__$1,new cljs.core.Keyword(null,"selected-token-coord","selected-token-coord",1371480460));
var developer_mode_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26499__$1,new cljs.core.Keyword(null,"developer-mode?","developer-mode?",-664498178));
var fog_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26499__$1,new cljs.core.Keyword(null,"fog-state","fog-state",-562317010));
...
var all_pixels = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26497_SHARP_){
return catan_board.utils.hex.axial_to_pixel(p1__26497_SHARP_,hex_size);
}),all_coords);
var landscape_mode_QMARK_ = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"landscape-mode?","landscape-mode?",1839338284)], null)));
...
var vec__26500 = catan_board.views.hex.compute_original_center(grid_pattern,all_pixels,padding);
var center_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26500,(0),null);
var center_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26500,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26506),catan_board$views$hex$hex_grid_$_iter__26503(cljs.core.chunk_rest(s__26504__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26506),null);
}
} else {
var hex_data = cljs.core.first(s__26504__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.hex.hex_tile,hex_data,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["hex-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword(null,"coord","coord",-1453656639).cljs$core$IFn$_invoke$arity$1(hex_data))),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(new cljs.core.Keyword(null,"coord","coord",-1453656639).cljs$core$IFn$_invoke$arity$1(hex_data)))].join('')], null)),catan_board$views$hex$hex_grid_$_iter__26503(cljs.core.rest(s__26504__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),(function (){var iter__5480__auto__ = (function catan_board$views$hex$hex_grid_$_iter__26507(s__26508){
return (new cljs.core.LazySeq(null,(function (){
var s__26508__$1 = s__26508;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26508__$1);
if(temp__5804__auto__){
var s__26508__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26508__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__26508__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__26510 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__26509 = (0);
while(true){
if((i__26509 < size__5479__auto__)){
var harbor_data = cljs.core._nth(c__5478__auto__,i__26509);
cljs.core.chunk_append(b__26510,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.hex.harbor_trapezoid,harbor_data], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["harbor-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword(null,"land-hex","land-hex",151922960).cljs$core$IFn$_invoke$arity$1(harbor_data))),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(new cljs.core.Keyword(null,"land-hex","land-hex",151922960).cljs$core$IFn$_invoke$arity$1(harbor_data))),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"direction","direction",-633359395).cljs$core$IFn$_invoke$arity$1(harbor_data))].join('')], null)));

var G__26569 = (i__26509 + (1));
i__26509 = G__26569;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26510),catan_board$views$hex$hex_grid_$_iter__26507(cljs.core.chunk_rest(s__26508__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26510),null);
}
} else {
var harbor_data = cljs.core.first(s__26508__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.hex.harbor_trapezoid,harbor_data], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["harbor-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword(null,"land-hex","land-hex",151922960).cljs$core$IFn$_invoke$arity$1(harbor_data))),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second(new cljs.core.Keyword(null,"land-hex","land-hex",151922960).cljs$core$IFn$_invoke$arity$1(harbor_data))),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"direction","direction",-633359395).cljs$core$IFn$_invoke$arity$1(harbor_data))].join('')], null)),catan_board$views$hex$hex_grid_$_iter__26507(cljs.core.rest(s__26508__$2)));
}
} else {
return null;
}
...
})()], null),(cljs.core.truth_(harbor_placement_coord)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.hex.harbor_direction_selector,harbor_placement_coord], null):null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),(function (){var iter__5480__auto__ = (function catan_board$views$hex$hex_grid_$_iter__26511(s__26512){
return (new cljs.core.LazySeq(null,(function (){
var s__26512__$1 = s__26512;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26512__$1);
if(temp__5804__auto__){
var s__26512__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26512__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__26512__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__26514 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__26513 = (0);
while(true){
if((i__26513 < size__5479__auto__)){
var map__26515 = cljs.core._nth(c__5478__auto__,i__26513);
var map__26515__$1 = cljs.core.__destructure_map(map__26515);
var coord = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26515__$1,new cljs.core.Keyword(null,"coord","coord",-1453656639));
cljs.core.chunk_append(b__26514,(function (){var hex_size__$1 = catan_board.db.hex_size;
var vertices = catan_board.utils.hex.hex_vertices(coord,hex_size__$1);
var iter__5480__auto__ = ((function (i__26513,hex_size__$1,vertices,map__26515,map__26515__$1,coord,c__5478__auto__,size__5479__auto__,b__26514,s__26512__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__26500,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__26499,map__26499__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state){
return (function catan_board$views$hex$hex_grid_$_iter__26511_$_iter__26516(s__26517){
return (new cljs.core.LazySeq(null,((function (i__26513,hex_size__$1,vertices,map__26515,map__26515__$1,coord,c__5478__auto__,size__5479__auto__,b__26514,s__26512__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__26500,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__26499,map__26499__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state){
return (function (){
var s__26517__$1 = s__26517;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__26517__$1);
if(temp__5804__auto____$1){
var s__26517__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__26517__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__26517__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__26519 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__26518 = (0);
while(true){
if((i__26518 < size__5479__auto____$1)){
var vec__26520 = cljs.core._nth(c__5478__auto____$1,i__26518);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26520,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26520,(1),null);
cljs.core.chunk_append(b__26519,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"cx","cx",1272694324),x,new cljs.core.Keyword(null,"cy","cy",755331060),y,new cljs.core.Keyword(null,"r","r",-471384190),(10),new cljs.core.Keyword(null,"fill","fill",883462889),catan_board.utils.hex.path_color], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["dot-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y)].join('')], null)));

var G__26574 = (i__26518 + (1));
i__26518 = G__26574;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26519),catan_board$views$hex$hex_grid_$_iter__26511_$_iter__26516(cljs.core.chunk_rest(s__26517__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26519),null);
}
} else {
var vec__26523 = cljs.core.first(s__26517__$2);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26523,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26523,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"cx","cx",1272694324),x,new cljs.core.Keyword(null,"cy","cy",755331060),y,new cljs.core.Keyword(null,"r","r",-471384190),(10),new cljs.core.Keyword(null,"fill","fill",883462889),catan_board.utils.hex.path_color], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["dot-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y)].join('')], null)),catan_board$views$hex$hex_grid_$_iter__26511_$_iter__26516(cljs.core.rest(s__26517__$2)));
}
} else {
return null;
}
...
});})(i__26513,hex_size__$1,vertices,map__26515,map__26515__$1,coord,c__5478__auto__,size__5479__auto__,b__26514,s__26512__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__26500,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__26499,map__26499__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state))
,null,null));
});})(i__26513,hex_size__$1,vertices,map__26515,map__26515__$1,coord,c__5478__auto__,size__5479__auto__,b__26514,s__26512__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__26500,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__26499,map__26499__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26514),catan_board$views$hex$hex_grid_$_iter__26511(cljs.core.chunk_rest(s__26512__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26514),null);
}
} else {
var map__26526 = cljs.core.first(s__26512__$2);
var map__26526__$1 = cljs.core.__destructure_map(map__26526);
var coord = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26526__$1,new cljs.core.Keyword(null,"coord","coord",-1453656639));
return cljs.core.cons((function (){var hex_size__$1 = catan_board.db.hex_size;
var vertices = catan_board.utils.hex.hex_vertices(coord,hex_size__$1);
var iter__5480__auto__ = ((function (hex_size__$1,vertices,map__26526,map__26526__$1,coord,s__26512__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__26500,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__26499,map__26499__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state){
return (function catan_board$views$hex$hex_grid_$_iter__26511_$_iter__26527(s__26528){
return (new cljs.core.LazySeq(null,(function (){
var s__26528__$1 = s__26528;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__26528__$1);
if(temp__5804__auto____$1){
var s__26528__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__26528__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__26528__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__26530 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__26529 = (0);
while(true){
if((i__26529 < size__5479__auto__)){
var vec__26531 = cljs.core._nth(c__5478__auto__,i__26529);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26531,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26531,(1),null);
cljs.core.chunk_append(b__26530,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"cx","cx",1272694324),x,new cljs.core.Keyword(null,"cy","cy",755331060),y,new cljs.core.Keyword(null,"r","r",-471384190),(10),new cljs.core.Keyword(null,"fill","fill",883462889),catan_board.utils.hex.path_color], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["dot-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y)].join('')], null)));

var G__26582 = (i__26529 + (1));
i__26529 = G__26582;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26530),catan_board$views$hex$hex_grid_$_iter__26511_$_iter__26527(cljs.core.chunk_rest(s__26528__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26530),null);
}
} else {
var vec__26534 = cljs.core.first(s__26528__$2);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26534,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26534,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"circle","circle",1903212362),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"cx","cx",1272694324),x,new cljs.core.Keyword(null,"cy","cy",755331060),y,new cljs.core.Keyword(null,"r","r",-471384190),(10),new cljs.core.Keyword(null,"fill","fill",883462889),catan_board.utils.hex.path_color], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["dot-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y)].join('')], null)),catan_board$views$hex$hex_grid_$_iter__26511_$_iter__26527(cljs.core.rest(s__26528__$2)));
}
} else {
return null;
}
...
});})(hex_size__$1,vertices,map__26526,map__26526__$1,coord,s__26512__$2,temp__5804__auto__,scenario_config,hex_size,all_coords,all_pixels,landscape_mode_QMARK_,harbor_placement_coord,editor_mode_QMARK_,draft,display_harbors,grid_pattern,padding,vec__26500,center_x,center_y,min_x,max_x,min_y,max_y,view_x,view_y,view_width,view_height,map__26499,map__26499__$1,scenario,hexes,harbors,swap_number_mode_QMARK_,selected_token_coord,developer_mode_QMARK_,fog_state))
;
return iter__5480__auto__(vertices);
})(),catan_board$views$hex$hex_grid_$_iter__26511(cljs.core.rest(s__26512__$2)));
}
} else {
return null;
}
