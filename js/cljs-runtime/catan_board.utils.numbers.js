...
var deck = cljs.core.flatten((function (){var iter__5480__auto__ = (function catan_board$utils$numbers$create_number_deck_$_iter__25690(s__25693){
return (new cljs.core.LazySeq(null,(function (){
var s__25693__$1 = s__25693;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__25693__$1);
if(temp__5804__auto__){
var s__25693__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25693__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__25693__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__25695 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__25694 = (0);
while(true){
if((i__25694 < size__5479__auto__)){
var vec__25700 = cljs.core._nth(c__5478__auto__,i__25694);
var number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25700,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25700,(1),null);
cljs.core.chunk_append(b__25695,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(count,number));

var G__25735 = (i__25694 + (1));
i__25694 = G__25735;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25695),catan_board$utils$numbers$create_number_deck_$_iter__25690(cljs.core.chunk_rest(s__25693__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25695),null);
}
} else {
var vec__25715 = cljs.core.first(s__25693__$2);
var number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25715,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25715,(1),null);
return cljs.core.cons(cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(count,number),catan_board$utils$numbers$create_number_deck_$_iter__25690(cljs.core.rest(s__25693__$2)));
}
} else {
return null;
}
