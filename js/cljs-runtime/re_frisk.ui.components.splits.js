...
var G__11093 = current_node.parentNode;
var G__11094 = (sum_scroll_left + current_node.scrollLeft);
var G__11095 = (sum_scroll_top + current_node.scrollTop);
current_node = G__11093;
sum_scroll_left = G__11094;
sum_scroll_top = G__11095;
continue;
} else {
...
var vec__10917 = (cljs.core.truth_(size_only)?split_size_only:null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10917,(0),null);
var num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10917,(1),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10917,(2),null);
...
var len__5726__auto___11098 = arguments.length;
var i__5727__auto___11099 = (0);
while(true){
if((i__5727__auto___11099 < len__5726__auto___11098)){
args__5732__auto__.push((arguments[i__5727__auto___11099]));

var G__11100 = (i__5727__auto___11099 + (1));
i__5727__auto___11099 = G__11100;
continue;
} else {
}
break;
...
return re_frisk.ui.components.splits.h_split.cljs$core$IFn$_invoke$arity$variadic(argseq__5733__auto__);
});

(re_frisk.ui.components.splits.h_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__11003){
var map__11004 = p__11003;
var map__11004__$1 = cljs.core.__destructure_map(map__11004);
var args = map__11004__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11004__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11004__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11004__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11004__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11004__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11004__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11004__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
var document__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11004__$1,new cljs.core.Keyword(null,"document","document",-1329188687),document);
...
var G__11009_11101 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__11009_11101) : on_split_change.call(null,G__11009_11101));
} else {
}
...
return (function() { 
var G__11105__delegate = function (p__11026){
var map__11028 = p__11026;
var map__11028__$1 = cljs.core.__destructure_map(map__11028);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11028__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
while (G__11106__i < G__11106__a.length) {G__11106__a[G__11106__i] = arguments[G__11106__i + 0]; ++G__11106__i;}
  p__11026 = new cljs.core.IndexedSeq(G__11106__a,0,null);
} 
return G__11105__delegate.call(this,p__11026);};
G__11105.cljs$lang$maxFixedArity = 0;
G__11105.cljs$lang$applyTo = (function (arglist__11107){
var p__11026 = cljs.core.seq(arglist__11107);
return G__11105__delegate(p__11026);
});
...
/** @this {Function} */
(re_frisk.ui.components.splits.h_split.cljs$lang$applyTo = (function (seq10969){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq10969));
}));
...
var args__5732__auto__ = [];
var len__5726__auto___11110 = arguments.length;
var i__5727__auto___11113 = (0);
while(true){
if((i__5727__auto___11113 < len__5726__auto___11110)){
args__5732__auto__.push((arguments[i__5727__auto___11113]));

var G__11115 = (i__5727__auto___11113 + (1));
i__5727__auto___11113 = G__11115;
continue;
} else {
}
break;
...
var argseq__5733__auto__ = ((((0) < args__5732__auto__.length))?(new cljs.core.IndexedSeq(args__5732__auto__.slice((0)),(0),null)):null);
return re_frisk.ui.components.splits.v_split.cljs$core$IFn$_invoke$arity$variadic(argseq__5733__auto__);
});

(re_frisk.ui.components.splits.v_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__11051){
var map__11052 = p__11051;
var map__11052__$1 = cljs.core.__destructure_map(map__11052);
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11052__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11052__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11052__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11052__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11052__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11052__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11052__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
var document__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11052__$1,new cljs.core.Keyword(null,"document","document",-1329188687),document);
...
var stop_drag = (function (){
if(cljs.core.truth_(on_split_change)){
var G__11056_11116 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__11056_11116) : on_split_change.call(null,G__11056_11116));
} else {
}
...
return (function() { 
var G__11128__delegate = function (p__11076){
var map__11077 = p__11076;
var map__11077__$1 = cljs.core.__destructure_map(map__11077);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var open_bottom_split_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"open-bottom-split?","open-bottom-split?",953160965));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var close_bottom_split_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"close-bottom-split?","close-bottom-split?",1606756910));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11077__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var perc = (cljs.core.truth_(close_bottom_split_QMARK_)?"0":(cljs.core.truth_((function (){var and__5000__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(split_perc),parseInt(initial_split));
...
while (G__11138__i < G__11138__a.length) {G__11138__a[G__11138__i] = arguments[G__11138__i + 0]; ++G__11138__i;}
  p__11076 = new cljs.core.IndexedSeq(G__11138__a,0,null);
} 
return G__11128__delegate.call(this,p__11076);};
G__11128.cljs$lang$maxFixedArity = 0;
G__11128.cljs$lang$applyTo = (function (arglist__11139){
var p__11076 = cljs.core.seq(arglist__11139);
return G__11128__delegate(p__11076);
});
...
/** @this {Function} */
(re_frisk.ui.components.splits.v_split.cljs$lang$applyTo = (function (seq11045){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq11045));
}));
