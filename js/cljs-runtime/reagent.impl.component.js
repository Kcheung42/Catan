...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11873 = c;
var G__11873__$1 = (((G__11873 == null))?null:G__11873.prototype);
if((G__11873__$1 == null)){
return null;
} else {
return G__11873__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__11895__delegate = function (args){
...
var or__5002__auto__ = (function (){var G__11875 = c;
var G__11875__$1 = (((G__11875 == null))?null:G__11875.constructor);
if((G__11875__$1 == null)){
return null;
} else {
return G__11875__$1.displayName;
}
})();
...
var G__11876 = c;
var G__11876__$1 = (((G__11876 == null))?null:G__11876.constructor);
if((G__11876__$1 == null)){
return null;
} else {
return G__11876__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__11877 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11878 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11878);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11877);
}});
...
var c = this;
var G__11881_11903 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__11881_11903 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11881_11903);
}
...
var renders_11904 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11905 = cljs.core.first(cljs.core.vals(renders_11904));
...
if((cljs.core.count(renders_11904) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11904))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11905)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11905], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__11882 = o;
reagent.impl.component.goog$module$goog$object.set(G__11882,cljs.core.name(k),v);
...
while (G__11908__i < G__11908__a.length) {G__11908__a[G__11908__i] = arguments[G__11908__i + 0]; ++G__11908__i;}
  args = new cljs.core.IndexedSeq(G__11908__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__11883 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11884 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11884);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11883);
}});
...
var vec__11885 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11885,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11885,(1),null);
...
var G__11888 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__11888 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__11888);
}
});
}),[]);
