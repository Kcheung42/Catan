...
var G__10559_10636 = re_com.selection_list.check_clicked(selections,item_id,cljs.core.not((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id))),required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__10559_10636) : on_change.call(null,G__10559_10636));
}
...
var G__10578_10641 = re_com.selection_list.radio_clicked(selections,item_id,required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__10578_10641) : on_change.call(null,G__10578_10641));
}
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__10602){
var map__10603 = p__10602;
var map__10603__$1 = cljs.core.__destructure_map(map__10603);
var args = map__10603__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10603__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer)?(function (p1__10597_SHARP_){
return (item_renderer.cljs$core$IFn$_invoke$arity$8 ? item_renderer.cljs$core$IFn$_invoke$arity$8(p1__10597_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_) : item_renderer.call(null,p1__10597_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_));
}):(cljs.core.truth_(multi_select_QMARK_)?(function (p1__10598_SHARP_){
return re_com.selection_list.as_checked(p1__10598_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
}):(function (p1__10599_SHARP_){
return re_com.selection_list.as_radio(p1__10599_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
}))),choices);
...
var len__5726__auto___10668 = arguments.length;
var i__5727__auto___10669 = (0);
while(true){
if((i__5727__auto___10669 < len__5726__auto___10668)){
args__5732__auto__.push((arguments[i__5727__auto___10669]));

var G__10671 = (i__5727__auto___10669 + (1));
i__5727__auto___10669 = G__10671;
continue;
} else {
}
break;
...
(re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__10617){
var map__10618 = p__10617;
var map__10618__$1 = cljs.core.__destructure_map(map__10618);
var args = map__10618__$1;
if((((!(goog.DEBUG)))?true:re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(re_com.validate.extract_arg_data(re_com.selection_list.selection_list_args_desc),args,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["selection-list"], 0)))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}
...
return (function() { 
var G__10673__delegate = function (p__10620){
var map__10621 = p__10620;
var map__10621__$1 = cljs.core.__destructure_map(map__10621);
var args__$1 = map__10621__$1;
...
while (G__10675__i < G__10675__a.length) {G__10675__a[G__10675__i] = arguments[G__10675__i + 0]; ++G__10675__i;}
  p__10620 = new cljs.core.IndexedSeq(G__10675__a,0,null);
} 
return G__10673__delegate.call(this,p__10620);};
G__10673.cljs$lang$maxFixedArity = 0;
G__10673.cljs$lang$applyTo = (function (arglist__10676){
var p__10620 = cljs.core.seq(arglist__10676);
return G__10673__delegate(p__10620);
});
...
/** @this {Function} */
(re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq10610){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq10610));
}));
