...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__7072 = c;
var G__7072__$1 = (((G__7072 == null))?null:G__7072.prototype);
if((G__7072__$1 == null)){
return null;
} else {
return G__7072__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__7074 = c;
var G__7074__$1 = (((G__7074 == null))?null:G__7074.prototype);
if((G__7074__$1 == null)){
return null;
} else {
return G__7074__$1.render;
}
})() == null)))));
});
...
while (G__7221__i < G__7221__a.length) {G__7221__a[G__7221__i] = arguments[G__7221__i + 0]; ++G__7221__i;}
  args = new cljs.core.IndexedSeq(G__7221__a,0,null);
} 
...
var or__5002__auto__ = (function (){var G__7086 = c;
var G__7086__$1 = (((G__7086 == null))?null:G__7086.constructor);
if((G__7086__$1 == null)){
return null;
} else {
return G__7086__$1.displayName;
}
})();
...
var G__7091 = c;
var G__7091__$1 = (((G__7091 == null))?null:G__7091.constructor);
if((G__7091__$1 == null)){
return null;
} else {
return G__7091__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__7099 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__7100 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__7100);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__7099);
}});
...
var G__7107 = key;
var G__7107__$1 = (((G__7107 instanceof cljs.core.Keyword))?G__7107.fqn:null);
switch (G__7107__$1) {
...
var or__5002__auto__ = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var c = this;
...
var c = this;
var G__7156_7228 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__7156_7228 == null)){
} else {
re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__7156_7228);
}
...
var renders_7231 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_7232 = cljs.core.first(cljs.core.vals(renders_7231));
...
if((cljs.core.count(renders_7231) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_7231))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_7232)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_7232], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var or__5002__auto____$1 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.util.fun_name(render_fun);
...
var G__7189 = o;
re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.set(G__7189,cljs.core.name(k),v);
...
var args = null;
if (arguments.length > 0) {
var G__7242__i = 0, G__7242__a = new Array(arguments.length -  0);
while (G__7242__i < G__7242__a.length) {G__7242__a[G__7242__i] = arguments[G__7242__i + 0]; ++G__7242__i;}
...
var args = cljs.core.seq(arglist__7243);
...
var _STAR_current_component_STAR__orig_val__7212 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__7213 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__7213);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__7212);
}});
...
var vec__7214 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7214,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7214,(1),null);
...
var G__7217 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__7217 == null)){
return null;
} else {
return re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__7217);
}
});
}),[]);
...
var and__5000__auto__ = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.util._STAR_always_update_STAR_ === false;
if(and__5000__auto__){
try{return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(old_argv,new_argv);
}catch (e7218){var e = e7218;
if(re_frisk.inlined_deps.reagent.v1v0v0.reagent.debug.has_console){
((re_frisk.inlined_deps.reagent.v1v0v0.reagent.debug.tracking)?re_frisk.inlined_deps.reagent.v1v0v0.reagent.debug.track_console:console).warn(["Warning: ","Exception thrown while comparing argv's in shouldComponentUpdate: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(old_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e)].join(''));
} else {
}
...
var or__5002__auto__ = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.cached_react_class(compiler,tag);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
