...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21783 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21783(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21784 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21784(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21785 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21785(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21786 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21786(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21787 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21787(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21788 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21788(reader);
}
});
