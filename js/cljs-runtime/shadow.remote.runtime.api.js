...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11932 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11932(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_11935 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_11935(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_11939 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_11939(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_11942 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_11942(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11946 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11946(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11948 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11948(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__11930,callback){
var map__11931 = p__11930;
var map__11931__$1 = cljs.core.__destructure_map(map__11931);
var input = map__11931__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11931__$1,new cljs.core.Keyword(null,"code","code",1586293142));
