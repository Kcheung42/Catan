 ...
 */
catan_board.scenarios.registry.scenarios = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"base-game","base-game",-2144481729),catan_board.scenarios.base_game_4p.config,new cljs.core.Keyword(null,"base-game-6p","base-game-6p",-493407125),catan_board.scenarios.base_game_6p.config,new cljs.core.Keyword(null,"fog-islands-3p","fog-islands-3p",1517052951),catan_board.scenarios.fog_islands_3p.config,new cljs.core.Keyword(null,"fog-islands-4p","fog-islands-4p",518474181),catan_board.scenarios.fog_islands_4p.config,new cljs.core.Keyword(null,"heading-for-new-shores-3p","heading-for-new-shores-3p",-1604177090),catan_board.scenarios.heading_for_new_shores_3p.config,new cljs.core.Keyword(null,"heading-for-new-shores-4p","heading-for-new-shores-4p",-404440366),catan_board.scenarios.heading_for_new_shores_4p.config], null);
/**
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"name","name",1843675177),(function (p1__35958_SHARP_){
return cljs.core.not(new cljs.core.Keyword(null,"custom-scenario?","custom-scenario?",-1855989644).cljs$core$IFn$_invoke$arity$1(p1__35958_SHARP_));
})),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__35959){
var vec__35960 = p__35959;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35960,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35960,(1),null);
