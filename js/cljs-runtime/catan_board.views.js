...
})], null),(function (){var iter__5480__auto__ = (function catan_board$views$scenario_selector_$_iter__23148(s__23149){
return (new cljs.core.LazySeq(null,(function (){
var s__23149__$1 = s__23149;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__23149__$1);
if(temp__5804__auto__){
var s__23149__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23149__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23149__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23151 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23150 = (0);
while(true){
if((i__23150 < size__5479__auto__)){
var scenario = cljs.core._nth(c__5478__auto__,i__23150);
cljs.core.chunk_append(b__23151,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scenario))], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(scenario)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scenario)], null)));

var G__23192 = (i__23150 + (1));
i__23150 = G__23192;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23151),catan_board$views$scenario_selector_$_iter__23148(cljs.core.chunk_rest(s__23149__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23151),null);
}
} else {
var scenario = cljs.core.first(s__23149__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scenario))], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(scenario)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scenario)], null)),catan_board$views$scenario_selector_$_iter__23148(cljs.core.rest(s__23149__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23161),catan_board$views$resource_distribution_editor_$_iter__23158(cljs.core.chunk_rest(s__23159__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23161),null);
}
} else {
var resource_type = cljs.core.first(s__23159__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.form-group.resource-input","div.form-group.resource-input",753398287),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),cljs.core.name(resource_type)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.form-input","input.form-input",-1259370157),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"min","min",444991522),"0",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$3(resources,resource_type,(0))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (resource_type,s__23159__$2,temp__5804__auto__,title,distribution_key,event_key,resources,resource_types){
return (function (p1__23156_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [event_key,resource_type,p1__23156_SHARP_.target.value], null));
});})(resource_type,s__23159__$2,temp__5804__auto__,title,distribution_key,event_key,resources,resource_types))
], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),resource_type], null)),catan_board$views$resource_distribution_editor_$_iter__23158(cljs.core.rest(s__23159__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23166),catan_board$views$number_token_distribution_editor_$_iter__23163(cljs.core.chunk_rest(s__23164__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23166),null);
}
} else {
var number = cljs.core.first(s__23164__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.form-group.number-input","div.form-group.number-input",437314250),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),cljs.core.str.cljs$core$IFn$_invoke$arity$1(number)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.form-input","input.form-input",-1259370157),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"min","min",444991522),"0",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$3(tokens,number,(0))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (number,s__23164__$2,temp__5804__auto__,title,distribution_key,event_key,tokens,token_numbers){
return (function (p1__23162_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [event_key,number,p1__23162_SHARP_.target.value], null));
});})(number,s__23164__$2,temp__5804__auto__,title,distribution_key,event_key,tokens,token_numbers))
], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),number], null)),catan_board$views$number_token_distribution_editor_$_iter__23163(cljs.core.rest(s__23164__$2)));
}
} else {
return null;
}
...
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"select"], null),"-- Select a scenario --"], null),(function (){var iter__5480__auto__ = (function catan_board$views$scenario_management_editor_$_iter__23169(s__23170){
return (new cljs.core.LazySeq(null,(function (){
var s__23170__$1 = s__23170;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__23170__$1);
if(temp__5804__auto__){
var s__23170__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23170__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23170__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23172 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23171 = (0);
while(true){
if((i__23171 < size__5479__auto__)){
var vec__23173 = cljs.core._nth(c__5478__auto__,i__23171);
var scenario_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23173,(0),null);
var scenario_config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23173,(1),null);
cljs.core.chunk_append(b__23172,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(scenario_id)], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(scenario_config)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),scenario_id], null)));

var G__23195 = (i__23171 + (1));
i__23171 = G__23195;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23172),catan_board$views$scenario_management_editor_$_iter__23169(cljs.core.chunk_rest(s__23170__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23172),null);
}
} else {
var vec__23177 = cljs.core.first(s__23170__$2);
var scenario_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23177,(0),null);
var scenario_config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23177,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(scenario_id)], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(scenario_config)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),scenario_id], null)),catan_board$views$scenario_management_editor_$_iter__23169(cljs.core.rest(s__23170__$2)));
}
} else {
return null;
}
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-landscape-mode","toggle-landscape-mode",-56367616)], null));
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.toggle-text","span.toggle-text",-231231114),"Landscape Mode"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.help-text","p.help-text",1523052202),"Flip orientation to landscape"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.board_scale,current_board_scale], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.scenario_management_editor], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.scenario_metadata_editor,draft], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.resource_distribution_editor,draft,new cljs.core.Keyword(null,"face-up","face-up",-200804391)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.number_token_distribution_editor,draft,new cljs.core.Keyword(null,"face-up","face-up",-200804391)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.resource_distribution_editor,draft,new cljs.core.Keyword(null,"fog","fog",1515389980)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.number_token_distribution_editor,draft,new cljs.core.Keyword(null,"fog","fog",1515389980)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.hex_type_selection_editor], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.views.editor_action_buttons,validation_errors], null)], null):null),((cljs.core.seq(validation_errors))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.control-section","div.control-section",1862512591),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.validation-errors","div.validation-errors",533771118),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),"Validation Errors:"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),(function (){var iter__5480__auto__ = (function catan_board$views$main_panel_$_iter__23182(s__23183){
return (new cljs.core.LazySeq(null,(function (){
var s__23183__$1 = s__23183;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__23183__$1);
if(temp__5804__auto__){
var s__23183__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23183__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23183__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23185 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23184 = (0);
while(true){
if((i__23184 < size__5479__auto__)){
var vec__23186 = cljs.core._nth(c__5478__auto__,i__23184);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23186,(0),null);
var error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23186,(1),null);
cljs.core.chunk_append(b__23185,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),error], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),field], null)));

var G__23196 = (i__23184 + (1));
i__23184 = G__23196;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23185),catan_board$views$main_panel_$_iter__23182(cljs.core.chunk_rest(s__23183__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23185),null);
}
} else {
var vec__23189 = cljs.core.first(s__23183__$2);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23189,(0),null);
var error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23189,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),error], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),field], null)),catan_board$views$main_panel_$_iter__23182(cljs.core.rest(s__23183__$2)));
}
} else {
return null;
}
