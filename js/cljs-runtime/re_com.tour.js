...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__10411_SHARP_,p2__10412_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__10411_SHARP_,p2__10412_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5480__auto__ = (function re_com$tour$initialise_tour_$_iter__10419(s__10420){
...
var c__5478__auto__ = cljs.core.chunk_first(s__10420__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__10422 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__10421 = (0);
while(true){
if((i__10421 < size__5479__auto__)){
var step = cljs.core._nth(c__5478__auto__,i__10421);
cljs.core.chunk_append(b__10422,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__10467 = (i__10421 + (1));
i__10421 = G__10467;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10422),re_com$tour$initialise_tour_$_iter__10419(cljs.core.chunk_rest(s__10420__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10422),null);
}
} else {
var step = cljs.core.first(s__10420__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__10419(cljs.core.rest(s__10420__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__10428 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__10428.cljs$core$IFn$_invoke$arity$1 ? fexpr__10428.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__10428.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__10440 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__10440.cljs$core$IFn$_invoke$arity$1 ? fexpr__10440.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__10440.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__10441 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__10441.cljs$core$IFn$_invoke$arity$1 ? fexpr__10441.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__10441.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__10451 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__10451.cljs$core$IFn$_invoke$arity$1 ? fexpr__10451.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__10451.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__10452 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__10452.cljs$core$IFn$_invoke$arity$1 ? fexpr__10452.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__10452.call(null,tour));
})(),true);
} else {
return null;
}
