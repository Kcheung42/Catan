...
var player_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12797__$1,new cljs.core.Keyword(null,"player-count","player-count",-1323180409));
var grid_pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12797__$1,new cljs.core.Keyword(null,"grid-pattern","grid-pattern",-1763214640));
var hex_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12797__$1,new cljs.core.Keyword(null,"hex-types","hex-types",-1144901913));
var face_up_distribution = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12797__$1,new cljs.core.Keyword(null,"face-up-distribution","face-up-distribution",1522439387));
var fog_distribution = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12797__$1,new cljs.core.Keyword(null,"fog-distribution","fog-distribution",792585602));
...
var G__12806 = db;
var G__12806__$1 = cljs.core.assoc_in(G__12806,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"custom-scenario-editor-mode","custom-scenario-editor-mode",-847536203)], null),cljs.core.not(editor_mode_QMARK_))
;
return cljs.core.assoc_in(G__12806__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"custom-scenario-draft","custom-scenario-draft",-1075652714)], null),(cljs.core.truth_(editor_mode_QMARK_)?null:catan_board.custom_editor.events.default_draft));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"update-scenario-name","update-scenario-name",617144459),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12813){
var vec__12814 = p__12813;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12814,(0),null);
var new_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12814,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"update-scenario-player-count","update-scenario-player-count",-322827805),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12817){
var vec__12818 = p__12817;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12818,(0),null);
var new_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12818,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"update-grid-pattern","update-grid-pattern",323988399),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12821){
var vec__12822 = p__12821;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12822,(0),null);
var new_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12822,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"update-face-up-resource","update-face-up-resource",839205879),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12825){
var vec__12826 = p__12825;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12826,(0),null);
var resource_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12826,(1),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12826,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"update-face-down-resource","update-face-down-resource",-585583305),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12829){
var vec__12830 = p__12829;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12830,(0),null);
var resource_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12830,(1),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12830,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"update-face-up-number","update-face-up-number",364870027),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12837){
var vec__12838 = p__12837;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12838,(0),null);
var number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12838,(1),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12838,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"update-face-down-number","update-face-down-number",1723284062),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12842){
var vec__12846 = p__12842;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12846,(0),null);
var number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12846,(1),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12846,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"set-editor-hex-selection-mode","set-editor-hex-selection-mode",-818346020),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12853){
var vec__12854 = p__12853;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12854,(0),null);
var mode = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12854,(1),null);
var G__12857 = db;
var G__12857__$1 = cljs.core.assoc_in(G__12857,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"editor-hex-selection-mode","editor-hex-selection-mode",869835898)], null),mode)
;
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(mode,new cljs.core.Keyword(null,"harbor","harbor",-638543472))){
return cljs.core.assoc_in(G__12857__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"harbor-placement-coord","harbor-placement-coord",-1362481537)], null),null);
} else {
return G__12857__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"assign-hex-type","assign-hex-type",-73552081),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12859){
var vec__12860 = p__12859;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12860,(0),null);
var coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12860,(1),null);
var hex_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12860,(2),null);
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"custom-scenario-draft","custom-scenario-draft",-1075652714),new cljs.core.Keyword(null,"hex-types","hex-types",-1144901913)], null),(function (p1__12858_SHARP_){
return catan_board.custom_editor.events.add_hex_to_type(p1__12858_SHARP_,coord,hex_type);
}));
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"clear-hex-assignment","clear-hex-assignment",-374118093),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12868){
var vec__12869 = p__12868;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12869,(0),null);
var coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12869,(1),null);
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"custom-scenario-draft","custom-scenario-draft",-1075652714),new cljs.core.Keyword(null,"hex-types","hex-types",-1144901913)], null),(function (p1__12867_SHARP_){
return catan_board.custom_editor.events.remove_hex_from_all_types(p1__12867_SHARP_,coord);
}));
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"place-harbor-at-hex","place-harbor-at-hex",1316086961),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12873){
var vec__12874 = p__12873;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12874,(0),null);
var coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12874,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"set-harbor-direction","set-harbor-direction",1655338539),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12877){
var vec__12878 = p__12877;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12878,(0),null);
var coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12878,(1),null);
var direction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12878,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"assign-harbor-type","assign-harbor-type",331169236),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12885){
var vec__12886 = p__12885;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12886,(0),null);
var land_hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12886,(1),null);
var direction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12886,(2),null);
var new_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12886,(3),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"remove-harbor","remove-harbor",-1945440553),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [catan_board.custom_editor.events.persist_db], null),(function (db,p__12889){
var vec__12890 = p__12889;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12890,(0),null);
var land_hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12890,(1),null);
var direction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12890,(2),null);
var harbors = cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"custom-scenario-draft","custom-scenario-draft",-1075652714),new cljs.core.Keyword(null,"harbors","harbors",1522363032)], null),cljs.core.PersistentVector.EMPTY);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"export-custom-scenario","export-custom-scenario",562744864),(function (p__12905,_){
var map__12906 = p__12905;
var map__12906__$1 = cljs.core.__destructure_map(map__12906);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12906__$1,new cljs.core.Keyword(null,"db","db",993250759));
var draft = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"custom-scenario-draft","custom-scenario-draft",-1075652714)], null));
var scenario_id = (function (){var or__5002__auto__ = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(draft);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
