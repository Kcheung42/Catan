...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10209 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10209(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10216 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10216(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10226 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10226(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10232 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10232(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10250 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10250(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10266 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10266(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10273 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10273(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10283 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10283(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10292 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10292(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10306 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10306(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10319 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10319(b);
}
});
