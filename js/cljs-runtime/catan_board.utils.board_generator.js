 ...
 */
catan_board.utils.board_generator.hex_neighbors = (function catan_board$utils$board_generator$hex_neighbors(p__12760){
var vec__12761 = p__12760;
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12761,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12761,(1),null);
...
var red_hexes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__12766_SHARP_){
return catan_board.utils.numbers.is_red_number_QMARK_(new cljs.core.Keyword(null,"number","number",1570378438).cljs$core$IFn$_invoke$arity$1(p1__12766_SHARP_));
}),hexes);
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__12772_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"tournament-mode","tournament-mode",1600337077),tournament_mode_QMARK_,new cljs.core.Keyword(null,"attempts","attempts",1024246729),(attempts + (1))], null)], 0));
});})(attempts,max_attempts,new_board,hexes))
);
} else {
var G__12781 = (attempts + (1));
var G__12782 = max_attempts;
attempts = G__12781;
max_attempts = G__12782;
continue;
}
}
break;
