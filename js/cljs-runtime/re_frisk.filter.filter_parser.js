...
var G__10864 = cljs.tools.reader.reader_types.peek_char(rdr);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__10864)){
...
var vec__10884 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10884,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10884,(1),null);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"free","free",801364328),prefix], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),(function (){var or__5002__auto__ = rest;
...
try{var map__10900 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
var map__10900__$1 = cljs.core.__destructure_map(map__10900);
var foo = map__10900__$1;
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10900__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10900__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
...
try{var map__10908 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
var map__10908__$1 = cljs.core.__destructure_map(map__10908);
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10908__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10908__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"expr","expr",745722291),val], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),rest], null);
}catch (e10903){var _ = e10903;
var vec__10904 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10904,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10904,(1),null);
var prefix__$1 = clojure.string.replace(prefix,/^\"/,"");
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"string-prefix","string-prefix",2091851734),prefix__$1], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),(function (){var or__5002__auto__ = rest;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return "";
...
var G__10920 = cljs.core.first(s);
switch (G__10920) {
case "[":
case "(":
case "{":
...
var map__10925 = re_frisk.filter.filter_parser.parse_part(s__$2);
var map__10925__$1 = cljs.core.__destructure_map(map__10925);
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10925__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10925__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
