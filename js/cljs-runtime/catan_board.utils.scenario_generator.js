...
var resource_deck = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__26300){
var vec__26301 = p__26300;
var resource = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26301,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26301,(1),null);
...
return cljs.core.shuffle(cljs.core.vec(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__26304){
var vec__26305 = p__26304;
var token = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26305,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26305,(1),null);
 ...
 */
catan_board.utils.scenario_generator.classify_hex_by_type = (function catan_board$utils$scenario_generator$classify_hex_by_type(coord,p__26308){
var map__26309 = p__26308;
var map__26309__$1 = cljs.core.__destructure_map(map__26309);
var hex_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26309__$1,new cljs.core.Keyword(null,"hex-types","hex-types",-1144901913));
 ...
 */
catan_board.utils.scenario_generator.generate_scenario_board = (function catan_board$utils$scenario_generator$generate_scenario_board(p__26330,random_harbor_mode_QMARK_){
var map__26331 = p__26330;
var map__26331__$1 = cljs.core.__destructure_map(map__26331);
var scenario_config = map__26331__$1;
var grid_pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26331__$1,new cljs.core.Keyword(null,"grid-pattern","grid-pattern",-1763214640));
var face_up_distribution = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26331__$1,new cljs.core.Keyword(null,"face-up-distribution","face-up-distribution",1522439387));
var harbors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26331__$1,new cljs.core.Keyword(null,"harbors","harbors",1522363032));
var all_coords = catan_board.utils.hex.generate_grid_from_pattern(grid_pattern);
var classified_coords = cljs.core.group_by((function (p1__26320_SHARP_){
return catan_board.utils.scenario_generator.classify_hex_by_type(p1__26320_SHARP_,scenario_config);
}),all_coords);
...
var water_hexes = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__26322_SHARP_){
return catan_board.utils.scenario_generator.assign_resource_to_hex(p1__26322_SHARP_,new cljs.core.Keyword(null,"water","water",-824098213));
}),water_coords);
var fog_hexes = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__26323_SHARP_){
return catan_board.utils.scenario_generator.assign_resource_to_hex(p1__26323_SHARP_,new cljs.core.Keyword(null,"fog","fog",1515389980));
}),fog_coords);
...
var terrain_hexes_with_numbers = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__26324_SHARP_){
return catan_board.utils.scenario_generator.assign_number_to_hex(p1__26324_SHARP_,number_atom);
...
catan_board.utils.scenario_generator.initialize_fog_number_deck = (function catan_board$utils$scenario_generator$initialize_fog_number_deck(p__26334){
var map__26335 = p__26334;
var map__26335__$1 = cljs.core.__destructure_map(map__26335);
var fog_distribution = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26335__$1,new cljs.core.Keyword(null,"fog-distribution","fog-distribution",792585602));
 ...
 */
catan_board.utils.scenario_generator.initialize_fog_state = (function catan_board$utils$scenario_generator$initialize_fog_state(p__26336){
var map__26337 = p__26336;
var map__26337__$1 = cljs.core.__destructure_map(map__26337);
var hex_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26337__$1,new cljs.core.Keyword(null,"hex-types","hex-types",-1144901913));
var fog_distribution = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26337__$1,new cljs.core.Keyword(null,"fog-distribution","fog-distribution",792585602));
...
var resource_deck = cljs.core.shuffle(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__26340){
var vec__26341 = p__26340;
var resource = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26341,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26341,(1),null);
return cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(count,resource);
