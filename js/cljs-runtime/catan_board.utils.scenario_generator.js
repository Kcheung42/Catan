...
var resource_deck = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__33812){
var vec__33813 = p__33812;
var resource = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33813,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33813,(1),null);
...
return cljs.core.shuffle(cljs.core.vec(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__33825){
var vec__33827 = p__33825;
var token = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33827,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33827,(1),null);
 ...
 */
catan_board.utils.scenario_generator.classify_hex_by_type = (function catan_board$utils$scenario_generator$classify_hex_by_type(coord,p__33834){
var map__33835 = p__33834;
var map__33835__$1 = cljs.core.__destructure_map(map__33835);
var hex_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33835__$1,new cljs.core.Keyword(null,"hex-types","hex-types",-1144901913));
...
var vec__33837 = cljs.core.deref(number_atom);
...
var num1 = first__33839;
var first__33839__$1 = cljs.core.first(seq__33838__$1);
var seq__33838__$2 = cljs.core.next(seq__33838__$1);
var num2 = first__33839__$1;
var remain = seq__33838__$2;
 ...
 */
catan_board.utils.scenario_generator.generate_scenario_board = (function catan_board$utils$scenario_generator$generate_scenario_board(p__33848,random_harbor_mode_QMARK_){
var map__33849 = p__33848;
var map__33849__$1 = cljs.core.__destructure_map(map__33849);
var scenario_config = map__33849__$1;
var grid_pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33849__$1,new cljs.core.Keyword(null,"grid-pattern","grid-pattern",-1763214640));
var face_up_distribution = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33849__$1,new cljs.core.Keyword(null,"face-up-distribution","face-up-distribution",1522439387));
var harbors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33849__$1,new cljs.core.Keyword(null,"harbors","harbors",1522363032));
var all_coords = catan_board.utils.hex.generate_grid_from_pattern(grid_pattern);
var classified_coords = cljs.core.group_by((function (p1__33841_SHARP_){
return catan_board.utils.scenario_generator.classify_hex_by_type(p1__33841_SHARP_,scenario_config);
}),all_coords);
...
var village_coords = cljs.core.get.cljs$core$IFn$_invoke$arity$3(classified_coords,new cljs.core.Keyword(null,"village","village",-950412200),cljs.core.PersistentVector.EMPTY);
...
var water_hexes = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__33842_SHARP_){
return catan_board.utils.scenario_generator.assign_resource_to_hex(p1__33842_SHARP_,new cljs.core.Keyword(null,"water","water",-824098213));
}),water_coords);
var fog_hexes = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__33843_SHARP_){
return catan_board.utils.scenario_generator.assign_resource_to_hex(p1__33843_SHARP_,new cljs.core.Keyword(null,"fog","fog",1515389980));
}),fog_coords);
var village_hexes = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__33844_SHARP_){
return catan_board.utils.scenario_generator.assign_resource_to_hex(p1__33844_SHARP_,new cljs.core.Keyword(null,"village","village",-950412200));
}),village_coords);
...
var terrain_hexes_with_numbers = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__33845_SHARP_){
return catan_board.utils.scenario_generator.assign_number_to_hex(p1__33845_SHARP_,number_atom);
...
catan_board.utils.scenario_generator.initialize_fog_number_deck = (function catan_board$utils$scenario_generator$initialize_fog_number_deck(p__33851){
var map__33852 = p__33851;
var map__33852__$1 = cljs.core.__destructure_map(map__33852);
var fog_distribution = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33852__$1,new cljs.core.Keyword(null,"fog-distribution","fog-distribution",792585602));
...
/**
 * Creates shuffled deck of terrain types for fog hexes.
 * 
 * Returns a shuffled sequence of terrain keywords based on fog distribution.
 */
catan_board.utils.scenario_generator.initialize_fog_terrain_deck = (function catan_board$utils$scenario_generator$initialize_fog_terrain_deck(p__33853){
var map__33854 = p__33853;
var map__33854__$1 = cljs.core.__destructure_map(map__33854);
var fog_distribution = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33854__$1,new cljs.core.Keyword(null,"fog-distribution","fog-distribution",792585602));
if(cljs.core.truth_(fog_distribution)){
return cljs.core.shuffle(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__33855){
var vec__33856 = p__33855;
var resource = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33856,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33856,(1),null);
return cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(count,resource);
 ...
 */
catan_board.utils.scenario_generator.initialize_fog_state = (function catan_board$utils$scenario_generator$initialize_fog_state(p__33859){
var map__33860 = p__33859;
var map__33860__$1 = cljs.core.__destructure_map(map__33860);
var hex_types = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33860__$1,new cljs.core.Keyword(null,"hex-types","hex-types",-1144901913));
