...
var len__5726__auto___12798 = arguments.length;
var i__5727__auto___12799 = (0);
while(true){
if((i__5727__auto___12799 < len__5726__auto___12798)){
args__5732__auto__.push((arguments[i__5727__auto___12799]));

var G__12800 = (i__5727__auto___12799 + (1));
i__5727__auto___12799 = G__12800;
continue;
} else {
}
break;
...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__12736){
var map__12737 = p__12736;
var map__12737__$1 = cljs.core.__destructure_map(map__12737);
var m = map__12737__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12737__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12737__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12737__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12737__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5802__auto___12804 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5802__auto___12804){
var unknown_keys_12805 = temp__5802__auto___12804;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_12805], 0));
} else {
}
} else {
}

var G__12740 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5002__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12740,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__12740;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq12732){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12732));
}));
...
var args__5732__auto__ = [];
var len__5726__auto___12807 = arguments.length;
var i__5727__auto___12808 = (0);
while(true){
if((i__5727__auto___12808 < len__5726__auto___12807)){
args__5732__auto__.push((arguments[i__5727__auto___12808]));

var G__12809 = (i__5727__auto___12808 + (1));
i__5727__auto___12808 = G__12809;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq12745){
var G__12746 = cljs.core.first(seq12745);
var seq12745__$1 = cljs.core.next(seq12745);
var G__12747 = cljs.core.first(seq12745__$1);
var seq12745__$2 = cljs.core.next(seq12745__$1);
var G__12748 = cljs.core.first(seq12745__$2);
var seq12745__$3 = cljs.core.next(seq12745__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12746,G__12747,G__12748,seq12745__$3);
}));
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq12753){
...
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12754,G__12755,G__12756,seq12753__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__12759,interceptor,direction){
var map__12760 = p__12759;
var map__12760__$1 = cljs.core.__destructure_map(map__12760);
var context = map__12760__$1;
var original_exception_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12760__$1,new cljs.core.Keyword("re-frame.interceptor","original-exception?","re-frame.interceptor/original-exception?",-527923945));
...
var args__5732__auto__ = [];
var len__5726__auto___12828 = arguments.length;
var i__5727__auto___12829 = (0);
while(true){
if((i__5727__auto___12829 < len__5726__auto___12828)){
args__5732__auto__.push((arguments[i__5727__auto___12829]));

var G__12830 = (i__5727__auto___12829 + (1));
i__5727__auto___12829 = G__12830;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.merge_ex_data.cljs$lang$applyTo = (function (seq12772){
var G__12773 = cljs.core.first(seq12772);
var seq12772__$1 = cljs.core.next(seq12772);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12773,seq12772__$1);
}));
...
var map__12778 = cljs.core.ex_data(re_frame_error);
var map__12778__$1 = cljs.core.__destructure_map(map__12778);
var event_v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12778__$1,new cljs.core.Keyword(null,"event-v","event-v",1378681365));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12778__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var interceptor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12778__$1,new cljs.core.Keyword(null,"interceptor","interceptor",1127739076));
...
var G__12785 = cljs.core.ex_cause(e);
var G__12786 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__12785,G__12786) : error_handler.call(null,G__12785,G__12786));
}}
});
