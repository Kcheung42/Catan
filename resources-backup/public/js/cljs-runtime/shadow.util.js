...
var len__5726__auto___10204 = arguments.length;
var i__5727__auto___10205 = (0);
while(true){
if((i__5727__auto___10205 < len__5726__auto___10204)){
args_arr__5751__auto__.push((arguments[i__5727__auto___10205]));

var G__10206 = (i__5727__auto___10205 + (1));
i__5727__auto___10205 = G__10206;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq10163){
var G__10166 = cljs.core.first(seq10163);
var seq10163__$1 = cljs.core.next(seq10163);
var G__10167 = cljs.core.first(seq10163__$1);
var seq10163__$2 = cljs.core.next(seq10163__$1);
var G__10168 = cljs.core.first(seq10163__$2);
var seq10163__$3 = cljs.core.next(seq10163__$2);
var G__10169 = cljs.core.first(seq10163__$3);
var seq10163__$4 = cljs.core.next(seq10163__$3);
var G__10170 = cljs.core.first(seq10163__$4);
var seq10163__$5 = cljs.core.next(seq10163__$4);
var G__10171 = cljs.core.first(seq10163__$5);
var seq10163__$6 = cljs.core.next(seq10163__$5);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10166,G__10167,G__10168,G__10169,G__10170,G__10171,seq10163__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__10179){
var vec__10180 = p__10179;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10180,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10180,(1),null);
