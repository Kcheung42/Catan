...
var i_12825 = (self__.level + (1));
while(true){
if((i_12825 <= (new_level + (1)))){
(update[i_12825] = self__.header);

var G__12826 = (i_12825 + (1));
i_12825 = G__12826;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_12827 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12827[i]));
} else {
x__$2.forward.push((((i < links_12827.length))?(links_12827[i]):null));
}

if((i < links_12827.length)){
(links_12827[i] = x__$2);
} else {
links_12827.push(x__$2);
}
...
var i_12834 = (0);
while(true){
if((i_12834 <= self__.level)){
var links_12835 = (update[i_12834]).forward;
if((x__$1 === (((i_12834 < links_12835.length))?(links_12835[i_12834]):null))){
(links_12835[i_12834] = (x__$1.forward[i_12834]));

var G__12836 = (i_12834 + (1));
i_12834 = G__12836;
continue;
} else {
var G__12837 = (i_12834 + (1));
i_12834 = G__12837;
continue;
}
} else {
...
var G__12842 = nx;
var G__12843 = (level__$1 - (1));
x = G__12842;
level__$1 = G__12843;
continue;
} else {
var G__12845 = x;
var G__12846 = (level__$1 - (1));
x = G__12845;
level__$1 = G__12846;
continue;
}
