...
var G__11912 = o;
reagent.impl.template.goog$module$goog$object.set(G__11912,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__11930__delegate = function (args){
...
while (G__11931__i < G__11931__a.length) {G__11931__a[G__11931__i] = arguments[G__11931__i + 0]; ++G__11931__i;}
  args = new cljs.core.IndexedSeq(G__11931__a,0,null);
} 
...
var args = cljs.core.seq(arglist__11932);
...
var G__11913 = o;
reagent.impl.template.goog$module$goog$object.set(G__11913,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__11933__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__11936__i < G__11936__a.length) {G__11936__a[G__11936__i] = arguments[G__11936__i + 0]; ++G__11936__i;}
  args = new cljs.core.IndexedSeq(G__11936__a,0,null);
} 
return G__11933__delegate.call(this,args);};
G__11933.cljs$lang$maxFixedArity = 0;
G__11933.cljs$lang$applyTo = (function (arglist__11937){
...
var G__11914 = props;
var G__11914__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11914,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11914);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11914__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11915 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11915,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11915;
}
})(),id_class);
...
var G__11916 = (cljs.core.count(argv) - first_child);
switch (G__11916) {
case (0):
...
var vec__11917 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11917,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11917,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11917,(2),null);
...
var temp__5808__auto___11951 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11951 == null)){
} else {
var key_11953 = temp__5808__auto___11951;
(jsprops.key = key_11953);
}
...
var temp__5808__auto___11954 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11954 == null)){
} else {
var key_11956 = temp__5808__auto___11954;
...
var temp__5808__auto___11960 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___11960 == null)){
} else {
var key_11961 = temp__5808__auto___11960;
(jsprops.key = key_11961);
}
...
var temp__5808__auto___11967 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11967 == null)){
} else {
var key_11968 = temp__5808__auto___11967;
(jsprops.key = key_11968);
}
...
var temp__5808__auto___11970 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11970 == null)){
} else {
var key_11971 = temp__5808__auto___11970;
(jsprops.key = key_11971);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11920_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11920_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11921 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11921,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11921,(1),null);
...
break;
default:
var G__11979 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__11980 = compiler;
v = G__11979;
compiler = G__11980;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template11927 = (function (opts,id,fn_to_element,parse_fn,meta11928){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11927.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11929,meta11928__$1){
var self__ = this;
var _11929__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11927(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11928__$1));
}));

(reagent.impl.template.t_reagent$impl$template11927.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11929){
var self__ = this;
var _11929__$1 = this;
return self__.meta11928;
}));

(reagent.impl.template.t_reagent$impl$template11927.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11927.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11927.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11927.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11927.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11927.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11928","meta11928",36241119,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11927.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11927.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11927");

(reagent.impl.template.t_reagent$impl$template11927.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template11927");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11927.
 */
reagent.impl.template.__GT_t_reagent$impl$template11927 = (function reagent$impl$template$__GT_t_reagent$impl$template11927(opts,id,fn_to_element,parse_fn,meta11928){
return (new reagent.impl.template.t_reagent$impl$template11927(opts,id,fn_to_element,parse_fn,meta11928));
});
...
return (new reagent.impl.template.t_reagent$impl$template11927(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
