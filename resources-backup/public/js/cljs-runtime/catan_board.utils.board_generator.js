 ...
 */
catan_board.utils.board_generator.hex_neighbors = (function catan_board$utils$board_generator$hex_neighbors(p__14239){
var vec__14240 = p__14239;
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14240,(0),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14240,(1),null);
...
var red_hexes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__14243_SHARP_){
return catan_board.utils.numbers.is_red_number_QMARK_(new cljs.core.Keyword(null,"number","number",1570378438).cljs$core$IFn$_invoke$arity$1(p1__14243_SHARP_));
}),hexes);
 ...
 */
catan_board.utils.board_generator.generate_board = (function catan_board$utils$board_generator$generate_board(tournament_mode_QMARK_){
var coords = catan_board.utils.hex.generate_catan_grid();
var hexes_with_resources = catan_board.utils.board_generator.assign_resources(coords);
var harbors = catan_board.utils.harbors.assign_harbors();
var attempts = (0);
var max_attempts = (100);
while(true){
if((attempts >= max_attempts)){
var hexes = catan_board.utils.board_generator.assign_numbers(hexes_with_resources);
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"hexes","hexes",-1419989846),hexes,new cljs.core.Keyword(null,"harbors","harbors",1522363032),harbors,new cljs.core.Keyword(null,"metadata","metadata",1799301597),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"generated-at","generated-at",-567727583),(new Date()).toISOString(),new cljs.core.Keyword(null,"board-id","board-id",-1767919501),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()),new cljs.core.Keyword(null,"tournament-mode","tournament-mode",1600337077),tournament_mode_QMARK_,new cljs.core.Keyword(null,"attempts","attempts",1024246729),attempts], null)], null);
} else {
var hexes = catan_board.utils.board_generator.assign_numbers(hexes_with_resources);
...
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"hexes","hexes",-1419989846),hexes,new cljs.core.Keyword(null,"harbors","harbors",1522363032),harbors,new cljs.core.Keyword(null,"metadata","metadata",1799301597),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"generated-at","generated-at",-567727583),(new Date()).toISOString(),new cljs.core.Keyword(null,"board-id","board-id",-1767919501),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()),new cljs.core.Keyword(null,"tournament-mode","tournament-mode",1600337077),tournament_mode_QMARK_,new cljs.core.Keyword(null,"attempts","attempts",1024246729),(attempts + (1))], null)], null);
} else {
var G__14263 = (attempts + (1));
var G__14264 = max_attempts;
attempts = G__14263;
max_attempts = G__14264;
continue;
}
}
break;
