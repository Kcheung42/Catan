...
var deck = cljs.core.flatten((function (){var iter__5480__auto__ = (function catan_board$utils$numbers$create_number_deck_$_iter__13865(s__13866){
return (new cljs.core.LazySeq(null,(function (){
var s__13866__$1 = s__13866;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__13866__$1);
if(temp__5804__auto__){
var s__13866__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13866__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__13866__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__13868 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__13867 = (0);
while(true){
if((i__13867 < size__5479__auto__)){
var vec__13869 = cljs.core._nth(c__5478__auto__,i__13867);
var number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13869,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13869,(1),null);
cljs.core.chunk_append(b__13868,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(count,number));

var G__13875 = (i__13867 + (1));
i__13867 = G__13875;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13868),catan_board$utils$numbers$create_number_deck_$_iter__13865(cljs.core.chunk_rest(s__13866__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13868),null);
}
} else {
var vec__13872 = cljs.core.first(s__13866__$2);
var number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13872,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13872,(1),null);
return cljs.core.cons(cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(count,number),catan_board$utils$numbers$create_number_deck_$_iter__13865(cljs.core.rest(s__13866__$2)));
}
} else {
return null;
}
