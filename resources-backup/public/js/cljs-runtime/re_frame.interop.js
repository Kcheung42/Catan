...
return [(function (){var pred__12102 = cljs.core.instance_QMARK_;
var expr__12103 = reactive_val;
if(cljs.core.truth_((pred__12102.cljs$core$IFn$_invoke$arity$2 ? pred__12102.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__12103) : pred__12102.call(null,reagent.ratom.RAtom,expr__12103)))){
return "ra";
} else {
if(cljs.core.truth_((pred__12102.cljs$core$IFn$_invoke$arity$2 ? pred__12102.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__12103) : pred__12102.call(null,reagent.ratom.RCursor,expr__12103)))){
return "rc";
} else {
if(cljs.core.truth_((pred__12102.cljs$core$IFn$_invoke$arity$2 ? pred__12102.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__12103) : pred__12102.call(null,reagent.ratom.Reaction,expr__12103)))){
return "rx";
} else {
if(cljs.core.truth_((pred__12102.cljs$core$IFn$_invoke$arity$2 ? pred__12102.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__12103) : pred__12102.call(null,reagent.ratom.Track,expr__12103)))){
return "tr";
} else {
return "other";
}
